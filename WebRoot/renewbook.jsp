...
ArrayList<book> newlist = (ArrayList<book>) session.getAttribute("renewbook.jsp");
%>
...
<html>
  ...
  <body>
   	<form action="servlet_admsearch" name="search2" method="post" class="sc form">
			...
			<input name = "yemian" type="hidden" name="test" value="renewbook.jsp" />
	...
	%>	
	   ...
	   <tr>
	    ...
	    <INPUT name="renewbook" type="button" value="修改书籍" onClick="location.href='servlet_getbook?bookid=<%=list.getBookid() %>'"></th>
	  </tr>
	  <%}} %>
	  </table>
